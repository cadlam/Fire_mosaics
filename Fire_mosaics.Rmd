...
pacman::p_load(tidyverse, emmeans, ggplot2, cowplot, vegan, data.table, kableExtra, plyr, nloptr, labdsv, betapart)
...
#write.csv(insect_dat_wide, "output/insect_data_wide.csv")
...
lichen_dat_totals1 <- lichen_dat_wide[,-1] %>% 
