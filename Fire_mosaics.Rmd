...
### MRPP (plants)
```{r echo = F}
plant.mrpp <- mrpp(plant_dat_cov_w[,c(2:181)], plant_dat_cov_w$sev)

# Save and change plotting parameters
def.par <- par(no.readonly = TRUE)
layout(matrix(1:2,nr=1))

plot(plant.ord <- metaMDS(plant_dat_cov_w[,c(2:181)]), type="text", display="sites" )
...
plant.md <- meandist(vegdist(plant_dat_cov_w[,c(2:181)]), plant_dat_cov_w$sev) # Need to adjust the columns to only keep species.... should fix this
plant.md
summary(plant.md)
plot(plant.md)
