...
### MRPP (plants)
```{r echo = F}
plant.mrpp <- mrpp(plant_dat_cov_w[,c(2:181)], plant_dat_cov_w$sev_cov)
...
plant.md <- meandist(vegdist(plant_dat_cov_w[,c(2:181)]), plant_dat_cov_w$sev_cov) # Need to adjust the columns to only keep species.... should fix this
plant.md
summary(plant.md)
plot(plant.md)
