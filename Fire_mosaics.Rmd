...
plant.mrpp <- mrpp(mrpp_data, mrpp_cat) # 2:181 for all plants; 2:57 for trees/shrubs
...
plant.md <- meandist(vegdist(mrpp_data, mrpp_cat)) # Need to adjust the columns to only keep species.... should fix this
plant.md
summary(plant.md)
plot(plant.md)
