...
pacman::p_load(tidyverse, emmeans, ggplot2, cowplot, vegan, data.table, kableExtra, plyr, nloptr, labdsv, betapart, lattice, rowr, plotly)
...
NMDS.log<- (nmds_dat[,-1]) #previously tried log1p transformation for 2018, but with both years the stress is too high
...
scrs <- cbind(scrs, site_id = plant_dat_pa_w$site_id)
