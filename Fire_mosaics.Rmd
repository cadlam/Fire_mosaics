...
plant.md <- meandist(vegdist(mrpp_data), mrpp_cat$sev, method = "bray") # Need to adjust the columns to only keep species.... should fix this
plant.md
summary(plant.md)
plot(plant.md)
...
bird.mrpp <- mrpp(mrpp_data, bird_dat_w1$sev, distance = "binomial")
...
## meandist 
# calculates a matrix of mean within-cluster dissimilarities (diagonal) and between-cluster dissimilarities (off-diagonal elements)
bird.md <- meandist(vegdist(mrpp_data), bird_dat_w1$sev, method = "binomial")
bird.md
summary(bird.md)
plot(bird.md)
```
...
mrpp_data <- lichen_dat_genus_pa_w %>% select(Ahtiana:Xanthomendoza)

mrpp_cat <- lichen_dat_genus_pa_w
